...
def write_metrics_to_bigquery(algo_name, training_time, model_metrics):
    ...
    table_id = "udemy-mlops-430513.ml_ops.advertising_roi_model_metrics"
...
def main():
    ...
    campaign_file_path = "gs://saq-ml-ops/advertising_roi/campaign_spend.csv"
    df_spend = read_campaign_data(campaign_file_path)

    revenue_file_path = "gs://saq-ml-ops/advertising_roi/monthly_revenue.csv"
